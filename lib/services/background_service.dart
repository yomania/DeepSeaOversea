...
Future<void> _calculateOfflineProduction() async {
  ...
  // Open Boxes
  final resourceBox = await Hive.openBox<ResourceModel>(GameConstants.boxResources);
  final unitBox = await Hive.openBox<UnitModel>(GameConstants.boxUnits);
  final settingsBox = await Hive.openBox(GameConstants.boxSettings); // Generic box for timestamps
